...
using AllPermissionQuery = CB.Application.Handlers.RoleHandlers.Queries.AllPermissionQuery;
using AllRoleQuery = CB.Application.Handlers.RoleHandlers.Queries.AllRoleQuery;
using DeleteRoleCommand = CB.Application.Handlers.RoleHandlers.Commands.DeleteRoleCommand;
using GetRoleQuery = CB.Application.Handlers.RoleHandlers.Queries.GetRoleQuery;
using ListRoleQuery = CB.Application.Handlers.RoleHandlers.Queries.ListRoleQuery;
using RoleDto = CB.Application.Models.RoleDto;
using SaveRoleCommand = CB.Application.Handlers.RoleHandlers.Commands.SaveRoleCommand;
