...
using ListPricingQuery = CB.Application.Handlers.PricingHandlers.Queries.ListPricingQuery;
using PricingDto = CB.Application.Models.PricingDto;
using SavePricingCommand = CB.Application.Handlers.PricingHandlers.Commands.SavePricingCommand;
