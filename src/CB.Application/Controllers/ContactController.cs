...
using GetContactCommand = CB.Application.Handlers.ContactHandlers.Queries.GetContactCommand;
using ListContactQuery = CB.Application.Handlers.ContactHandlers.Queries.ListContactQuery;
using SaveContactCommand = CB.Application.Handlers.ContactHandlers.Commands.SaveContactCommand;
