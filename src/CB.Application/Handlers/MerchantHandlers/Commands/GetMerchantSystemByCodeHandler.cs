...
public class GetMerchantSystemByCodeHandler(IServiceProvider serviceProvider) : BaseHandler<GetMerchantSystemByCodeCommand, MerchantSystemData>(serviceProvider) {
