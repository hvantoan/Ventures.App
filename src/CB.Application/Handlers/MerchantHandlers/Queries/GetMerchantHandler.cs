...
using Models_MerchantDto = CB.Application.Models.MerchantDto;

namespace CB.Application.Handlers.MerchantHandlers.Queries;

public class GetMerchantQuery : Common.Request<Models_MerchantDto> { }

public class GetMerchantHandler(IServiceProvider serviceProvider) : Common.BaseHandler<GetMerchantQuery, Models_MerchantDto>(serviceProvider) {
