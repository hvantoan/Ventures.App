...
using UserPermissionDto = CB.Application.Models.UserPermissionDto;
...
public class LoginHandler(IServiceProvider serviceProvider) : Common.BaseHandler<LoginCommand, LoginResult>(serviceProvider) {
