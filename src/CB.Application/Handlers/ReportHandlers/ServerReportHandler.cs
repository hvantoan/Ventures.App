...
public class ServerReportQuery : Common.Request<List<ServerReport>> {
    public int Month { get; set; }
    public int Year { get; set; }
}

internal class ServerReportHandler(IServiceProvider serviceProvider) : Common.BaseHandler<ServerReportQuery, List<ServerReport>>(serviceProvider) {
