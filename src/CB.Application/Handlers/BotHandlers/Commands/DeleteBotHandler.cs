...
public class DeleteBotCommand : SingleRequest<string> { }

internal class DeleteBotHandler(IServiceProvider serviceProvider) : BaseHandler<DeleteBotCommand, string>(serviceProvider) {
