...
public class ListBotQuery : Common.PaginatedRequest<ListBot> { }

public class ListBot : Common.PaginatedList<Models_BotDto> { }

internal class ListBotHandler(IServiceProvider serviceProvider) : Common.BaseHandler<ListBotQuery, ListBot>(serviceProvider) {
