...
public class GetMeQuery : Common.ModelRequest<Models_UserDto, Models_UserDto?> { }

public class GetMeHandler(IServiceProvider serviceProvider) : Common.BaseHandler<GetMeQuery, Models_UserDto?>(serviceProvider) {
