...
namespace CB.Infrastructure.Database.Migrations
{
    ...
    [Migration("20240908044728_Add-Transaction-Datas")]
    partial class AddTransactionDatas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CB.Domain.Entities.Account", b =>
                {
            ...
            modelBuilder.Entity("CB.Domain.Entities.AccountBot", b =>
                {
                    ...
                    b.HasKey("AccountId", "BotId");

                    b.HasIndex("BotId");

                    b.ToTable("AccountBot", "public");
                });
            ...
            modelBuilder.Entity("CB.Domain.Entities.AccountBot", b =>
                {
                    b.HasOne("CB.Domain.Entities.Account", "Account")
                        .WithMany("AccountBots")
