...
namespace CB.Api.Handlers.BotHandlers.Commands;

public class SaveBotCommand : Common.ModelRequest<BotDto, string> {
}

internal class SaveBotHandler(IServiceProvider serviceProvider) : Common.BaseHandler<SaveBotCommand, string>(serviceProvider) {
