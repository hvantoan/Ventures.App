using CB.Api.Models.ImportModels;
...
public class ImportTransactionCommand : Common.Request<FileResult?> {
    public IFormFile? File { get; set; }
}

public class ImportTransactionHandlers(IServiceProvider serviceProvider) : Common.BaseHandler<ImportTransactionCommand, FileResult?>(serviceProvider) {
