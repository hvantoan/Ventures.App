...
namespace CB.Api.Handlers.MeHandlers.Queries;

public class GetMeQuery : Common.ModelRequest<UserDto, UserDto?> { }

public class GetMeHandler(IServiceProvider serviceProvider) : Common.BaseHandler<GetMeQuery, UserDto?>(serviceProvider) {
