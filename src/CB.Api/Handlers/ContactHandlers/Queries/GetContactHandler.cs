...
namespace CB.Api.Handlers.ContactHandlers.Queries;

public class GetContactCommand : Common.SingleRequest<ContactDto> {
}

internal class GetContactHandler(IServiceProvider serviceProvider) : Common.BaseHandler<GetContactCommand, ContactDto>(serviceProvider) {
