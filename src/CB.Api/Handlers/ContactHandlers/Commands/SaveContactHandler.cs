...
namespace CB.Api.Handlers.ContactHandlers.Commands;

public class SaveContactCommand : Common.ModelRequest<ContactDto, string> { }

public class SaveContactHandler(IServiceProvider serviceProvider) : Common.BaseHandler<SaveContactCommand, string>(serviceProvider) {
