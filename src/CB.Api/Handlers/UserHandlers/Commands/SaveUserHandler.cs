...
namespace CB.Api.Handlers.UserHandlers.Commands;

public class SaveUserCommand : Common.ModelRequest<UserDto, string> {
    public bool IsSelfUpdate { get; set; }
}

public class SaveUserHandler(IServiceProvider serviceProvider) : Common.BaseHandler<SaveUserCommand, string>(serviceProvider) {
